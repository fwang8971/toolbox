...
const routes = [
  ...
  "/terms",
  "/disclaimer",
  "/guides/mortgage-payment-guide",
  "/guides/fixed-vs-variable-mortgage",
  "/guides/down-payment-guide",
  "/guides/home-affordability-basics",
  "/guides/loan-comparison-guide",
  "/guides/pay-off-loan-early-guide",
  "/guides/compound-interest-basics",
  "/guides/lump-sum-vs-monthly-investing",
  "/tools/calculator",
  "/tools/mortgage",
  "/tools/loan",
