...
const MESSAGES: Record<Locale, Messages> = {
  en: {
    ...
    "home.title": "Free mortgage, loan, compound interest, calculator, and word tools.",
    "home.subtitle":
      "Use fast online calculators and English practice tools with no login. Compare mortgage payments, loan costs, compound growth, and word patterns in one place.",
    ...
    "tools.title": "Online Tool Directory",
    "tools.subtitle":
      "Browse free calculators and language tools including mortgage, loan, compound interest, calculator, word chain, and word generator pages.",
  ...
  zh: {
    ...
    "home.title": "免费在线工具大全：房贷、贷款、复利、计算器与英语练习。",
    "home.subtitle":
      "无需登录即可使用房贷计算器、贷款计算器、复利计算器、在线计算器、单词接龙和单词生成器，适合真实搜索场景与快速测算。",
    ...
    "tools.title": "在线工具目录",
    "tools.subtitle":
      "汇总房贷计算器、贷款计算器、复利计算器、在线计算器和英语练习工具，全部免费使用，无需登录。",
